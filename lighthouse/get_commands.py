...
class GetCommands(Command):
    ...
    def all_hosts(self):
        return self.safe_call(self._api.get_all_hosts)

    def single_host(self, hostname):
        return self.safe_call(self._api.get_host, hostname)

    def discover_host_services(self, hostname):
        return self.safe_call(self._api.discover_services, hostname)

    def discover_services(self):
        return self.safe_call(self._api.discover_services_for_all_hosts)
